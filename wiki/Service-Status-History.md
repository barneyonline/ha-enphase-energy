...
gantt
    ...
    axisFormat  %b %d
    Window start :vert, window-start, 2026-08-24T01:15:20, 0ms
    Window end :vert, window-end, 2026-09-23T01:15:20, 0ms
    section Summary
    No incidents observed :done, 2026-09-23T01:15:20, 1m
```
