...
gantt
    ...
    axisFormat  %b %d
    Window start :vert, window-start, 2026-08-08T17:16:20, 0ms
    Window end :vert, window-end, 2026-09-07T17:16:20, 0ms
    section Summary
    No incidents observed :done, 2026-09-07T17:16:20, 1m
```
