...
gantt
    ...
    axisFormat  %b %d
    Window start :vert, window-start, 2026-08-11T10:39:16, 0ms
    Window end :vert, window-end, 2026-09-10T10:39:16, 0ms
    section Summary
    No incidents observed :done, 2026-09-10T10:39:16, 1m
```
