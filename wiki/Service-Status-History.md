...
gantt
    ...
    axisFormat  %b %d
    Window start :vert, window-start, 2026-08-20T14:38:20, 0ms
    Window end :vert, window-end, 2026-09-19T14:38:20, 0ms
    section Summary
    No incidents observed :done, 2026-09-19T14:38:20, 1m
```
