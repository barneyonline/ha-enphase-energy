...
gantt
    ...
    axisFormat  %b %d
    Window start :vert, window-start, 2026-08-06T23:45:04, 0ms
    Window end :vert, window-end, 2026-09-05T23:45:04, 0ms
    section Summary
    No incidents observed :done, 2026-09-05T23:45:04, 1m
```
