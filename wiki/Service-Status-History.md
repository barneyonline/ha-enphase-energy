...
gantt
    ...
    axisFormat  %b %d
    Window start :vert, window-start, 2026-08-13T08:03:12, 0ms
    Window end :vert, window-end, 2026-09-12T08:03:12, 0ms
    section Summary
    No incidents observed :done, 2026-09-12T08:03:12, 1m
```
