...
gantt
    ...
    axisFormat  %b %d
    Window start :vert, window-start, 2026-08-06T19:57:10, 0ms
    Window end :vert, window-end, 2026-09-05T19:57:10, 0ms
    section Summary
    No incidents observed :done, 2026-09-05T19:57:10, 1m
```
