...
- Last updated: `2026-08-27 10:10 UTC`
- Failed checks in latest run: `0`
- Latest failed checks: None
- Retained hourly samples: `678`
...
gantt
    ...
    axisFormat  %b %d
    Window start :vert, window-start, 2026-07-28T10:10:06, 0ms
    Window end :vert, window-end, 2026-08-27T10:10:06, 0ms
    section Down
