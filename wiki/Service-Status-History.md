...
gantt
    ...
    axisFormat  %b %d
    Window start :vert, window-start, 2026-08-11T00:50:40, 0ms
    Window end :vert, window-end, 2026-09-10T00:50:40, 0ms
    section Summary
    No incidents observed :done, 2026-09-10T00:50:40, 1m
```
