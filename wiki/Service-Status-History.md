...
gantt
    ...
    axisFormat  %b %d
    Window start :vert, window-start, 2026-08-07T15:37:19, 0ms
    Window end :vert, window-end, 2026-09-06T15:37:19, 0ms
    section Summary
    No incidents observed :done, 2026-09-06T15:37:19, 1m
```
