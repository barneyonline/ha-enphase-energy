...
gantt
    ...
    axisFormat  %b %d
    Window start :vert, window-start, 2026-08-17T06:25:28, 0ms
    Window end :vert, window-end, 2026-09-16T06:25:28, 0ms
    section Summary
    No incidents observed :done, 2026-09-16T06:25:28, 1m
```
