...
gantt
    ...
    axisFormat  %b %d
    Window start :vert, window-start, 2026-08-21T20:20:57, 0ms
    Window end :vert, window-end, 2026-09-20T20:20:57, 0ms
    section Summary
    No incidents observed :done, 2026-09-20T20:20:57, 1m
```
