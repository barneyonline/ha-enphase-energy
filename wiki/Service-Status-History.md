...
gantt
    ...
    axisFormat  %b %d
    Window start :vert, window-start, 2026-08-10T09:34:01, 0ms
    Window end :vert, window-end, 2026-09-09T09:34:01, 0ms
    section Summary
    No incidents observed :done, 2026-09-09T09:34:01, 1m
```
