...
gantt
    ...
    axisFormat  %b %d
    Window start :vert, window-start, 2026-08-19T21:25:08, 0ms
    Window end :vert, window-end, 2026-09-18T21:25:08, 0ms
    section Summary
    No incidents observed :done, 2026-09-18T21:25:08, 1m
```
